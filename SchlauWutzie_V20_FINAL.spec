...
"""PyInstaller spec for SchlauWutzie K.I. Video Studio V20.

The important part is that PyWinRT is collected by IMPORTABLE MODULE NAME,
not by the pip distribution name.  This avoids the old missing
winrt.windows.foundation runtime error in the EXE.
"""
...
# FFmpeg shipped by imageio-ffmpeg.
ff_datas, ff_binaries, ff_hidden = collect_all("imageio_ffmpeg")

# PyWinRT namespaces used by Microsoft OneCore / Microsoft Stefan.
# These are IMPORT names.  The corresponding pip packages are listed in
# requirements.txt.
winrt_modules = [
