...
def draw_neural_hud(
    ...
    Nur die zentrale, transparente K.I.-Animation liegt unten darüber.
    """
    ...
    # Minimaler transparenter Glasbereich – keine Seitenkästen.
    panel = (
        105,
        IN_H - 252,
        IN_W - 105,
    ...
    for x in range(x0, x1 + 1, 4):
        ...
        top_y = base_y - wave * amp
        bottom_y = base_y + wave * amp * 0.55
